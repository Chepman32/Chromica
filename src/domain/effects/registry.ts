...
export const EFFECTS: Effect[] = [
  ...
  },
  {
    ...
    name: 'Aurora',
    category: EffectCategory.RENDER,
    description: 'Ethereal northern lights with flowing colors',
    isPremium: false,
    complexity: 0.7,
    icon: require('../../assets/icons/filters/icon_effects_A/Fibers.png'),
    parameters: [
      {
        name: 'intensity',
        label: 'Intensity',
  ...
  },
  {
    ...
    name: 'Plasma',
    category: EffectCategory.RENDER,
    description: 'Classic swirling plasma with vibrant colors',
    isPremium: false,
    complexity: 0.6,
    icon: require('../../assets/icons/filters/icon_effects_A/Fibers.png'),
    parameters: [
  ...
  },
  {
    ...
    name: 'Lightning',
    category: EffectCategory.RENDER,
    description: 'Electric lightning bolts with glowing energy',
    isPremium: false,
    complexity: 0.8,
    icon: require('../../assets/icons/filters/icon_effects_A/Fibers.png'),
    parameters: [
  ...
  },
  {
    ...
    name: 'Nebula',
    category: EffectCategory.RENDER,
    description: 'Cosmic gas clouds with twinkling stars',
    isPremium: false,
    complexity: 0.7,
    icon: require('../../assets/icons/filters/icon_effects_A/Clouds.png'),
    parameters: [
  ...
  },
  {
    ...
    name: 'Energy Field',
    category: EffectCategory.RENDER,
    description: 'Flowing particle wave field with smooth undulations',
    isPremium: false,
    complexity: 0.7,
    icon: require('../../assets/icons/filters/icon_effects_A/Fibers.png'),
    parameters: [
