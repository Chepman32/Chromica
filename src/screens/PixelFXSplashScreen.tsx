/**
 * PixelFX animated splash screen
...
interface PixelFXSplashScreenProps {
  onFinish: () => void;
  initialLanguage?: string;
}

export const PixelFXSplashScreen: React.FC<PixelFXSplashScreenProps> = ({
  onFinish,
  initialLanguage,
}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.textContainer, textStyle]}>
        <Text style={styles.appName}>PixelFX</Text>
