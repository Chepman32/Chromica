...
enum CorivoDesign {
    ...
    static let themes: [ThemeType: CorivoTheme] = [
        .dark: CorivoTheme(
...
extension View {
    func corivoCard(theme: CorivoTheme) -> some View {
    ...
    func corivoButtonBackground(theme: CorivoTheme, accent: Bool = false) -> some View {
